...
import loading from '../public/WeatherIcons.gif'
...
function App() {
  ...
  return (
    <>
        <div>
        <img src="../public/background1.jpg" alt="Full Screen Image" className="absolute inset-0 object-cover w-full h-full brightness-70"/>
